...
-- (1, 'Producto Comercio 1', 'Producto asociado al primer comercio', 49.99, 'Electrónicos', 'Marca A', 'activo', 0),
-- (2, 'Producto Comercio 2', 'Producto asociado al segundo comercio', 29.99, 'Ropa', 'Marca B', 'en_oferta', 1);
