                ...
                <div class="row align-items-center">
                    <div class="col-xl-3 col-lg-4">
                        <div class="header-info">
                            <ul>
                                <li><i class="fi-rs-smartphone"></i> <a href="#">+507 3680-5249</a></li>
                                <li><i class="fi-rs-marker"></i><a  href="page-contact.html">Panamá, Panamá</a></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="header-wrap header-space-between position-relative">
                    ...
                    <div class="header-nav d-none d-lg-flex">
                        ...
                        <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block">
                            <nav>
                                <ul>
                                    <li><a class="active" href="index.php">Home <i class="fi-rs-angle"></i></a>
                                        <!--<ul class="dropdown">
                    ...
                    <div class="hotline d-none d-lg-block">
                        <p><i class="fi-rs-headset"></i><span>Hotline</span> +507 3680-5249 </p>
                    </div>
