...
echo "<h1>🧪 Checkout Simplificado - Test Paso a Paso</h1>";
...
// 6. Simular datos de checkout
echo "<h2>6. 🧪 Simulando Datos de Checkout</h2>";
try {
    $datosCheckout = [
        ...
        'notas' => 'Test desde página simplificada',
        'total' => $total,
        'subtotal' => $total,
        'envio' => 0.00,
        'impuestos' => 0.00
